...
`;class At extends HTMLElement{constructor(){super(),this._value=.5,this._max=1,this._min=0,this._step=.01,this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(Re.content.cloneNode(!0))}get slider(){return this.shadowRoot.getElementById("slider")}get label(){return this.shadowRoot.getElementById("label")}get valueElement(){return this.shadowRoot.getElementById("value")}get value(){return this._value}set value(t){this._value=t;const r=Math.round(t/this.step)*this.step,o=Intl.NumberFormat().format(r);this.slider.value=String(r),this.valueElement.textContent=o}get max(){return this._max}set max(t){this._max=t,this.slider.max=String(t)}get min(){return this._min}set min(t){this._min=t,this.slider.min=String(t)}get step(){return this._step}set step(t){this._step=t,this.slider.step=String(t)}connectedCallback(){const t=this.getAttribute("value");t&&(this.value=Number(t));const r=this.getAttribute("label");r&&(this.label.innerHTML=r);const o=this.getAttribute("max")||"1";this.max=Number(o);const a=this.getAttribute("min")||"0";this.min=Number(a);const u=this.getAttribute("step")||"0.01";this.step=Number(u);const c=this.getAttribute("background");c&&(this.slider.style.background=c),this.slider.addEventListener("input",()=>{const b=Number(this.slider.value);this.dispatchEvent(new CustomEvent("slider-change",{detail:b})),this.value=b}),this.slider.addEventListener("change",()=>{const b=Number(this.slider.value);this.dispatchEvent(new CustomEvent("slider-change",{detail:b})),this.value=b})}}window.customElements.define("slider-input",At);const we=document.createElement("template");we.innerHTML=`
  ...
  <slot></slot>
`;class qt extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(we.content.cloneNode(!0))}}window.customElements.define("shadow-box",qt);const Ce=document.createElement("template");Ce.innerHTML=`
   <style>
      :host {
        --hue: 180;
        --saturation: 1;
...
`;class Gt extends HTMLElement{constructor(){super(),this._colour=new R.Chromator({hue:0,saturation:0,lightness:.5}),this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(Ce.content.cloneNode(!0))}get hueRange(){return this.shadowRoot.getElementById("hue")}get saturationRange(){return this.shadowRoot.getElementById("saturation")}get lightnessRange(){return this.shadowRoot.getElementById("lightness")}get colour(){return this._colour}set colour(t){this._colour=t,this.hueRange.value=t.getHsl().hue,this.saturationRange.value=t.getHsl().saturation,this.lightnessRange.value=t.getHsl().lightness,this.style.setProperty("--hue",t.getHsl().hue.toString()),this.style.setProperty("--saturation",(t.getHsl().saturation*100).toString()+"%"),this.style.setProperty("--lightness",(t.getHsl().lightness*100).toString()+"%")}connectedCallback(){const t=this.getAttribute("value");t&&(this.colour=new R.Chromator(t)),this.hueRange.addEventListener("slider-change",()=>{this.dispatchEvent(new CustomEvent("hsl-change",{detail:new R.Chromator({...this.colour.getHsl(),hue:this.hueRange.value})}))}),this.saturationRange.addEventListener("slider-change",()=>{this.dispatchEvent(new CustomEvent("hsl-change",{detail:new R.Chromator({...this.colour.getHsl(),saturation:this.saturationRange.value})}))}),this.lightnessRange.addEventListener("slider-change",()=>{this.dispatchEvent(new CustomEvent("hsl-change",{detail:new R.Chromator({...this.colour.getHsl(),lightness:this.lightnessRange.value})}))}),this.addEventListener("hsl-change",r=>{this.colour=r.detail})}}window.customElements.define("colour-picker-hsl",Gt);const _e=document.createElement("template");_e.innerHTML=`
   <style>
      :host {
        --red: 64;
        --green: 191;
...
`;class Yt extends HTMLElement{constructor(){super(),this._colour=new R.Chromator({hue:0,saturation:0,lightness:.5}),this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(_e.content.cloneNode(!0))}get redRange(){return this.shadowRoot.getElementById("red")}get greenRange(){return this.shadowRoot.getElementById("green")}get blueRange(){return this.shadowRoot.getElementById("blue")}get colour(){return this._colour}set colour(t){this._colour=t;const r=t.getRgb();this.redRange.value=r.red,this.greenRange.value=r.green,this.blueRange.value=r.blue,this.style.setProperty("--red",r.red.toString()),this.style.setProperty("--green",r.green.toString()),this.style.setProperty("--blue",r.blue.toString())}connectedCallback(){const t=this.getAttribute("value");t&&(this.colour=new R.Chromator(t)),this.redRange.addEventListener("slider-change",()=>{this.dispatchEvent(new CustomEvent("rgb-change",{detail:new R.Chromator({...this.colour.getRgb(),red:this.redRange.value})}))}),this.greenRange.addEventListener("slider-change",()=>{this.dispatchEvent(new CustomEvent("rgb-change",{detail:new R.Chromator({...this.colour.getRgb(),green:this.greenRange.value})}))}),this.blueRange.addEventListener("slider-change",()=>{this.dispatchEvent(new CustomEvent("rgb-change",{detail:new R.Chromator({...this.colour.getRgb(),blue:this.blueRange.value})}))}),this.addEventListener("rgb-change",r=>{this.colour=r.detail})}}window.customElements.define("colour-picker-rgb",Yt);const xe=document.createElement("template");xe.innerHTML=`
  <style>
    :host {
      display: flex;
      flex-direction: row;
  ...
  <slot></slot>
`;class Zt extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(xe.content.cloneNode(!0))}}window.customElements.define("layout-row",Zt);const Oe=document.createElement("template");Oe.innerHTML=`
  <style>
    :host {
      display: flex;
      width: 100%;
...
`;class Kt extends HTMLElement{constructor(){super(),this._colour=new R.Chromator({hue:0,saturation:0,lightness:.5}),this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(Oe.content.cloneNode(!0))}get input(){return this.shadowRoot.getElementById("input")}get hexcode(){return this.shadowRoot.getElementById("hexcode")}get hsl(){return this.shadowRoot.getElementById("hsl")}get rgb(){return this.shadowRoot.getElementById("rgb")}get colour(){return this._colour}set colour(t){this._colour=t,this.input.value=t.getHexCode(),this.hsl.colour=t,this.rgb.colour=t,this.hexcode.textContent=t.getHexCode()}connectedCallback(){this.input.addEventListener("input",()=>{this.dispatchEvent(new CustomEvent("colour-change",{detail:new R.Chromator(this.input.value)}))}),this.hsl.addEventListener("hsl-change",t=>{this.dispatchEvent(new CustomEvent("colour-change",{detail:t.detail}))}),this.rgb.addEventListener("rgb-change",t=>{this.dispatchEvent(new CustomEvent("colour-change",{detail:t.detail}))}),this.addEventListener("colour-change",t=>{this.colour=t.detail})}}window.customElements.define("colour-picker",Kt);const Se=document.createElement("template");Se.innerHTML=`
  <style>
    :host {
      display: flex;
      flex-direction: column;
  ...
  <slot></slot>
`;class Jt extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(Se.content.cloneNode(!0))}}window.customElements.define("layout-column",Jt);const Ee=document.createElement("template");Ee.innerHTML=`
  <style>
    :host {
      display: flex;
      align-items: center;
  ...
  <span id="hex"></span>
`;class Qt extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(Ee.content.cloneNode(!0))}get colour(){return this._colour}set colour(t){this._colour=t;const r=t.getHexCode(),{hue:o,saturation:a,lightness:u}=t.getHsl(),c=t.getRelativeLuminance(),b=M.round(o,0),C=M.round(a,2),V=M.round(u,2),v=M.round(c,2),f=Intl.NumberFormat().format(b),E=Intl.NumberFormat().format(C),g=Intl.NumberFormat().format(V),h=Intl.NumberFormat().format(v);this.style.backgroundColor=r,this.style.color=c>1/3?"black":"white",this.title=`Hue: ${f}°; Saturation: ${E}; Lightness: ${g}; Relative luminance: ${h}`,this.hexElement.textContent=r}get hexElement(){return this.shadowRoot.querySelector("#hex")}connectedCallback(){const t=this.getAttribute("value");t!=null&&(this.colour=new R.Chromator(t))}}window.customElements.define("colour-box",Qt);const Pe=document.createElement("template");Pe.innerHTML=`
  <layout-column id="wrapper"></layout-column>
`;class er extends HTMLElement{constructor(){super(),this._colour=new R.Chromator({hue:0,saturation:1,lightness:.5}),this._numberOfShades=6,this._shadesProfile="luminance",this.boxes=[],this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(Pe.content.cloneNode(!0))}get wrapper(){return this.shadowRoot.querySelector("#wrapper")}get colour(){return this._colour}set colour(t){this._colour=t,this.setBoxes()}get numberOfShades(){return this._numberOfShades}set numberOfShades(t){this._numberOfShades=t,this.setBoxes()}get shadesProfile(){return this._shadesProfile}set shadesProfile(t){this._shadesProfile=t,this.setBoxes()}setBoxes(){const t=Dt(this.numberOfShades,this.colour,this.shadesProfile);this.boxes.length!==t.length?(this.boxes.forEach(r=>{r.remove()}),t.forEach(r=>{const o=document.createElement("colour-box");o.colour=r,this.wrapper.appendChild(o),this.boxes.push(o)})):this.boxes.forEach((r,o)=>{r.colour=t[o]})}connectedCallback(){const t=this.getAttribute("value");t!=null&&(this.colour=new R.Chromator(t)),this.setBoxes()}}window.customElements.define("colour-row",er);const Ve=document.createElement("template");Ve.innerHTML=`
  <shadow-box>
    <layout-column>
        <div>
...
`;class tr extends HTMLElement{constructor(){super(),this._colour=new R.Chromator({hue:0,saturation:1,lightness:.5}),this._numberOfOpposites=3,this._numberOfShades=6,this._shadesProfile="luminance",this.otherColourRows=[],this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(Ve.content.cloneNode(!0))}get mainColourRow(){return this.shadowRoot.querySelector("#maincolour")}get oppositesInput(){return this.shadowRoot.querySelector("#opposites")}get shadesInput(){return this.shadowRoot.querySelector("#shades")}get lightnessRadio(){return this.shadowRoot.querySelector("#lightness")}get luminanceRadio(){return this.shadowRoot.querySelector("#luminance")}get boxes(){return this.shadowRoot.querySelector("#boxes")}get colour(){return this._colour}set colour(t){this._colour=t,this.mainColourRow.colour=t,this.setOpposites()}get numberOfOpposites(){return this._numberOfOpposites}set numberOfOpposites(t){this._numberOfOpposites=t,this.setOpposites()}get numberOfShades(){return this._numberOfShades}set numberOfShades(t){this._numberOfShades=t,this.mainColourRow.numberOfShades=t,this.otherColourRows.forEach(r=>r.numberOfShades=t)}get shadesProfile(){return this._shadesProfile}set shadesProfile(t){this._shadesProfile=t,this.setShadeProfileInput(),this.mainColourRow.shadesProfile=t,this.otherColourRows.forEach(r=>r.shadesProfile=t)}setOpposites(){const t=ye(this.numberOfOpposites,this.colour);t.splice(0,1),this.otherColourRows.length!==t.length?(this.otherColourRows.forEach(r=>r.remove()),t.forEach(r=>{const o=document.createElement("colour-row");o.colour=r,o.numberOfShades=this.numberOfShades,o.shadesProfile=this.shadesProfile,this.boxes.appendChild(o),this.otherColourRows.push(o)})):t.forEach((r,o)=>{const a=this.otherColourRows[o];a.colour=r,a.numberOfShades=this.numberOfShades})}setShadeProfileInput(){switch(this.shadesProfile){case"lightness":this.lightnessRadio.checked=!0;break;case"luminance":this.luminanceRadio.checked=!0;break}}connectedCallback(){const t=this.getAttribute("value");t!=null&&(this.colour=new R.Chromator(t)),this.setOpposites(),this.setShadeProfileInput(),this.oppositesInput.addEventListener("input",()=>{this.numberOfOpposites=parseInt(this.oppositesInput.value),this.dispatchEvent(new CustomEvent("oppositeschange",{detail:this.numberOfOpposites}))}),this.shadesInput.addEventListener("input",()=>{this.numberOfShades=parseInt(this.shadesInput.value)}),this.lightnessRadio.addEventListener("change",()=>{this.lightnessRadio.checked&&(this.shadesProfile="lightness")}),this.luminanceRadio.addEventListener("change",()=>{this.luminanceRadio.checked&&(this.shadesProfile="luminance")})}}window.customElements.define("colour-properties",tr);const We=document.createElement("template");We.innerHTML=`
  <style>
    h1 {
      margin: 0;
    }
